...
def preprocess_prompts(tokenizer, prompts):
...
def get_preprocessed_toxic_chat_data(tokenizer):
    prompts, labels = get_toxic_chat_data()
    preprocessed_prompts = preprocess_prompts(tokenizer, prompts)
    return preprocessed_prompts, labels

def get_preprocessed_dummy_prompts_and_labels(tokenizer):
